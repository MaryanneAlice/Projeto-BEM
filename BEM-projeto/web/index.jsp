      ...
      <div class="row">
        <div class="col-lg-4 mb-6">
          <div class="card h-100">
            <h4 class="card-header">Ansiedade</h4>
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-6">
          <div class="card h-100">
            <h4 class="card-header">Depressão</h4>
            <div class="card-body">
              <p class="card-text">Depressão é um estado depressivo de humor, caracterizado por aversão à atividade, 
        ...
        <div class="col-lg-4 mb-8">
          <div class="card h-100">
            <h4 class="card-header">Estresse</h4>
            <div class="card-body">
              <p class="card-text">O estresse é o desgaste físico e mental causado pela soma de respostas físicas e mentais
